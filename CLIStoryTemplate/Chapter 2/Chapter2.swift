...
func chapterTwo() {
    ...
    func chooseseafood(herfavoriteseafood:favoriteSeafood) {
        ...
        //loop is right here, the things that are changing is the day of the week and the activity
    ...
    //------> below shows example of optional/ user input yes and output is backstory
